    ...
    <footer className="bg-black text-white py-8 px-6">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex justify-start lg:justify-end items-start gap-4">
          <FaTwitter className="text-lg cursor-pointer hover:text-gray-800" />
          <FaFacebook className="text-lg cursor-pointer hover:text-gray-800" />
          <FaYoutube className="text-lg cursor-pointer hover:text-gray-800" />
          <FaInstagram className="text-lg cursor-pointer hover:text-gray-800" />
        </div>
      </div>
